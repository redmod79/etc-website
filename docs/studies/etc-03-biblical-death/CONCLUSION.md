...
The word studies reveal that maveth (H4194, 160 occurrences) and mut (H4191, 835 occurrences) cover the entire range of death meaning in the OT. Thanatos (G2288, 119 occurrences) and apothnesko (G599, 112 occurrences) cover the entire range in the NT. The LXX translators rendered maveth as thanatos 97 times, confirming the semantic equivalence.
