...
This passage is sometimes read as teaching a conscious intermediate state between death and resurrection. What the text says: Paul desires to be "clothed upon" (5:2,4) -- to receive a new body -- NOT to be "unclothed" (to die). "Not for that we would be unclothed, but clothed upon" (5:4). The Greek word *ependyomai* (G1902, "to put on over") appears only twice in the entire NT, both in this passage. Paul had the simpler *endyo* ("to put on") available -- a word he uses 29 other times -- but chose the compound form to indicate layering: receiving the resurrection body *over* the mortal body. The purpose clause "that mortality might be swallowed up of life" uses the same root (*katapino*, G2666) as 1 Cor 15:54, confirming the same resurrection event is in view. The groaning of 5:2,4 (*stenazomen*, G4727) is the same verb and form used in Rom 8:23, where its object is explicitly "the redemption of our body" -- not escape from it. The phrase "absent from the body, present with the Lord" (5:8) expresses Paul's confidence that the next conscious experience after death will be the Lord's presence. The passage does not describe the mechanics of what happens between death and resurrection; it expresses a preference. Paul's own teaching in 1 Thess 4:16-17 places being with the Lord at the resurrection. For detailed Greek grammatical analysis of this passage, see [Study 19](../etc-19-2-corinthians-5-intermediate-state/CONCLUSION.md).
