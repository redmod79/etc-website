# Bible Study: Destruction Vocabulary -- Hebrew and Greek Words for the Fate of the Wicked
...
- **Total occurrences:** 219 (BLB count: 184)
...
- **Total occurrences:** 101 (BLB count: 90)
- **Key translation distribution:**
  - "to destroy" (8x, 7.9%)
  - "thou be destroyed" (5x, 5.0%)
  - "destroyed" (5x, 5.0%)
  - "shall be destroyed" (5x, 5.0%)
  - "destroy" (4x, 4.0%)
...
- **Total occurrences:** 254 (BLB count: 206)
- **Key translation distribution:**
...
- **Total occurrences:** 163 (BLB count: 147)
- **Key translation distribution:**
  - "destroy" (14x, 8.6%)
  - "to destroy" (13x, 8.0%)
  - "to destroy it" (7x, 4.3%)
  - "destroyed" (5x, 3.1%)
  - "corrupt" (3x, 1.8%)
  - "have destroyed" (3x, 1.8%)
  - "destroying" (3x, 1.8%)
...
**Passages using related destruction vocabulary (not the six primary words but forming the same semantic field):**
- Mal 4:1-3 -- "The day cometh, that shall burn as an oven; and all the proud... shall be stubble: and the day that cometh shall burn them up... they shall be ashes under the soles of your feet"
- Obadiah 1:16 -- "They shall be as though they had not been"
- Psa 37:10 -- "Yet a little while, and the wicked shall not be: yea, thou shalt diligently consider his place, and it shall not be"
- Psa 37:20 -- "The wicked shall perish... into smoke shall they consume away"
- Psa 68:2 -- "As wax melteth before the fire, so let the wicked perish at the presence of God"
- Isa 1:28,31 -- "They that forsake the LORD shall be consumed... the strong shall be as tow, and the maker of it as a spark, and they shall both burn together, and none shall quench them"
- Nah 1:10 -- "They shall be devoured as stubble fully dry"
- Matt 3:12 -- "He will burn up the chaff with unquenchable fire"
- Matt 13:30,40,42 -- "Gather the tares and bind them in bundles to burn them... cast them into a furnace of fire"
...
#### C. ECT/TORMENT VOCABULARY PASSAGES (for balanced analysis)
**The Research Agent must also retrieve and analyze these passages that use torment/punishment vocabulary:**
...
- Isa 66:24 -- "Their worm shall not die, neither shall their fire be quenched"
...
- Same death vocabulary used for physical, spiritual, and second death
...
- 44 items total (new): 35 E, 5 N, 4 I

**Cumulative from etc-01 through etc-05:** 269 items. Master evidence file contains E001-E211, N001-N026, I001-I035.
...
2. Read `D:/Bible/bible-studies/etc-master-evidence.md` for all 269 existing evidence items
3. Read CONCLUSION.md from all five prior etc- studies:
   ...
   - `D:/Bible/bible-studies/etc-05-four-hell-words/CONCLUSION.md`
...
- WICKED (PEOPLE) -- especially "Compared with" section (destruction similes)
...
- `04-word-studies.md` -- Strong's research for all six primary words plus related terms
...
---
*Scoped: 2026-02-20*
*Folder: D:/Bible/bible-studies/etc-06-destruction-vocabulary/*
