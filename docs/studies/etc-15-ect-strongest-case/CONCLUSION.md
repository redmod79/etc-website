...
- Most items from these passages were already registered in prior studies (etc6-09 through etc6-14). This study does not duplicate existing master IDs. New items are added with IDs continuing from E419, N061, I070.
...
| E9 | Isa 66:24 describes "carcases" (peger — dead bodies, 24 OT uses, always = corpse) | Isa 66:24 | Cond. | E192 |
...
- E192 (Isa 66:24 peger/carcasses): Classified Conditionalist in etc6-14. All four gates passed.
- E090 (2 Thess 1:9 everlasting destruction): Classified Conditionalist in etc6-14. All four gates passed.
- E303 (aionios used for past time): Classified Conditionalist in etc6-08. All four gates passed.
- E302 (Jude 1:7 aionios fire for Sodom): Classified Conditionalist in etc6-08. All four gates passed.
...
*(Covered by etc6-11-smoke-ascending-forever I-B resolution)*
...
*(Covered by etc6-12-tormented-forever I-B resolution)*
...
*(Covered by etc6-14-judgment-passages I-B resolution, I063)*
...
*(Covered by etc6-14-judgment-passages I-B resolution, I064)*
...
|--------|-----------|-----------|----------|----------------|
| E420 | ECT scholarly case (Peterson, Burk, Morgan) identifies Matt 25:46 and Rev 14:9-11 as the two strongest ECT passages | Web research | Neutral | etc6-15 |
| E421 | ECT scholars (per Sprinkle) acknowledge Mark 9:43-48 imagery is "a bit of a stretch" as standalone ECT evidence | Web research | Neutral | etc6-15 |
| E422 | ECT scholars acknowledge Luke 16:19-31 describes hades (intermediate state), not the final hell/lake of fire | Web research | Neutral | etc6-15 |
| I071 | Rev 14:9-11 describes eternal conscious torment of human wicked (fire-and-brimstone = literal ongoing torment) | I-B | ECT-direction | etc6-15 |
| I072 | Rev 14:9-11 uses OT fire-and-brimstone imagery of completed destruction with permanent result | I-A | Cond. | etc6-15 |
| I073 | Rev 20:10 extends to humans via same destination (lake of fire = same experience) | I-B | ECT-direction | etc6-15 |
| I074 | Rev 20:10 torment applies to non-human subjects; text distinguishes human fate as "second death" | I-A | Cond. | etc6-15 |
| I075 | Mark 9:43-48 describes eternal conscious torment via undying worm and unquenchable fire | I-C | ECT-direction | etc6-15 |
| I076 | Mark 9:43-48 quotes Isa 66:24 — worm and fire consume dead bodies (peger) | I-A | Cond. | etc6-15 |
| I077 | Luke 16:19-31 proves conscious post-mortem suffering and supports ECT anthropology | I-C | ECT-direction | etc6-15 |
| I078 | Rev 6:9-11 proves conscious disembodied souls, supporting ECT anthropology | I-C | ECT-direction | etc6-15 |
| I079 | The theological argument: sin against infinite God warrants infinite punishment | I-C | ECT-direction | etc6-15 |
| I080 | Resurrection of the wicked into bodies "fit for eternal suffering" (Burk) | I-C | ECT-direction | etc6-15 |

Existing items with "Also In" updated to include etc6-15:
...
### Positional Tally (Cumulative: etc6-01b through etc6-15)
...
4. Mark 9:43-48 quotes Isaiah 66:24. In Isa 66:24, the subjects of the worm and fire are peger (carcasses/dead bodies). Peger never refers to a living person in its 24 OT occurrences. The context (Isa 66:16-17) states the transgressors were slain and consumed.
