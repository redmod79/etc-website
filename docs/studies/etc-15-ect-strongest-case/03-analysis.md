...
## Methodology
This study presents the best case for Eternal Conscious Torment (ECT) as articulated by its scholarly defenders (Peterson, Burk, Morgan), then examines each argument against the textual evidence gathered in prior etc6 studies. The role is investigator, not advocate. Each of the 8 passages is evaluated at the E/N/I tier level. The ECT argument is steelmanned before the methodology is applied.
...
### Prior Study Findings (etc6-14, etc6-08)
- Kolasis means punishment/penalty (penal infliction), not torment (basanismos). The text says "punishment," not "torment"
- Aionios does not inherently mean "endless" — duration determined by nature of subject (etc6-08). Used for past time (Rom 16:25; 2 Tim 1:9). Jude 1:7 uses aionios for Sodom's fire (no longer burning)
...
- None of the 8 judgment passages uses basanizo for human wicked (etc6-14)
...
- Peger occurs 24 times in the OT, always meaning dead body/corpse, never a living person
...
### Prior Study Findings (etc6-05, etc6-14)
...
- In Isa 66:24, the objects of dera'on are peger (dead bodies/corpses — 24 OT occurrences, always = corpse)
...
### Prior Study Findings (etc6-14, etc6-07)
- Olam does not inherently mean "eternal" — duration determined by nature of subject (etc6-07)
...
**3. Cross-reference to etc6-17:** The proportionality texts (Luke 12:47-48, Matt 10:15, Rom 2:5-6) are also analyzed in etc6-17 under "Proportional Punishment," where they are shown to support proportional justice (consistent with conditionalism — punishment fitted to the crime) rather than infinite torment (which is disproportionate by definition, since infinite punishment for finite sin violates the proportionality principle the texts establish).
