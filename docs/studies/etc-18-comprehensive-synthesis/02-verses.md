# etc-18: Comprehensive Synthesis -- Verse Reference

## Note
This is a synthesis study. No new verse retrieval was performed. All verse texts are documented in the 17 prior studies (etc-01 through etc-17) and their respective 02-verses.md files.

## Key Verses Across the Series

The 17 studies collectively examined hundreds of biblical passages. The most frequently cited verses across multiple studies (based on the "Also In" column in etc-master-evidence.md) include:

### Most Cross-Referenced Verses
- **Gen 2:7** -- Man formed from dust + breath = living soul (etc-01, foundational)
...
- **1 Cor 15:53-54** -- This mortal must put on immortality (etc-01, 02, 04)
- **Rev 20:14** -- Lake of fire = second death (etc-05, 12, 13)
- **Rev 20:10** -- Devil, beast, false prophet tormented (etc-08, 11, 12, 13, 15)
- **Matt 25:46** -- Everlasting punishment / life eternal (etc-08, 14, 15)
- **2 Thess 1:9** -- Everlasting destruction (etc-06, 08, 14, 15)
- **Isa 34:10** -- Edom's smoke for ever (etc-07, 08, 11, 15)
- **Ezek 18:4,20** -- The soul that sins shall die (etc-01, 02, 03, 10, 17)

For complete verse texts with context, see the individual study 02-verses.md files.
