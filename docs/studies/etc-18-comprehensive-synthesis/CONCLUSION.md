...
*Note: ECT-direction includes items marked "ECT" and "ECT-direction" in etc6-evidence.db.*
...
### Finding 1: Man is mortal; the soul is not inherently immortal (etc6-01b, 02)
...
### Finding 2: Death is cessation; the dead are unconscious (etc6-03, 04)
...
### Finding 3: The Bible uses destruction vocabulary, not torment vocabulary, for the wicked's fate (etc6-05, 06)
...
### Finding 4: "Forever" language does not inherently mean endless (etc6-07, 08)
...
### Finding 5: Every ECT proof-text, when examined at E/N/I tier, produces 0 ECT E-items (etc6-09 through 15, 19, 20)
...
### Finding 6: ECT entered Christianity through Greek philosophy, not biblical teaching (etc6-16)
...
### Finding 7: God's character and justice are consistent with proportional destruction, not infinite torment (etc6-17)
...
- **Perishing** (apollumi -- John 3:16; Luke 13:3,5; 2 Pet 3:9)
- **Being destroyed** (apollumi, shamad, olethros -- Matt 10:28; 2 Thess 1:9; Ps 145:20)
- **Dying** (muth, thanatos -- Rom 6:23; Ezek 18:4,20; Gen 2:17)
- **Being consumed** (kalah -- Ps 37:20; 104:35; Heb 10:27)
...
3. **Intertestamental development.** The etc6-16 study traced historical channels but did not perform a full textual analysis of intertestamental literature (1 Enoch, 4 Maccabees, Wisdom of Solomon). A dedicated study could classify intertestamental eschatological statements at the E/N/I level.

4. **Patristic evidence.** The historical study (etc6-16) surveyed the patristic landscape broadly. A more detailed study could classify specific patristic statements about the fate of the wicked, tracking the shift from conditional to innate immortality.
...
7. **Intermediate state.** The studies addressed the intermediate state in several places (etc6-04, 09, 10) but a dedicated study focused on all intermediate-state passages and their relationship to the final fate question could strengthen or qualify findings.
...
### Positional Tally (Final Cumulative: etc6-01b through etc6-20)
...
- etc6-01b: Gen 35:18 and 1 Kings 17:21-22 (nephesh departing/returning — Neutral)
- etc6-02: Acts 17:18-32 (Greek philosophers mock resurrection, not soul immortality)
- etc6-03: Gen 2:17 "spiritual death" counter-argument fully engaged
- etc6-04: 1 Sam 28 narrator-endorsement problem analyzed
- etc6-05: Gehenna-as-trash-dump claim shown to lack pre-medieval attestation
- etc6-06: Obadiah 1:16 ("as though they had not been") + apollymi/Luke 15 counter-argument
- etc6-09: Abraham's bosom intertestamental background assessed
- etc6-11: Rev 14:10 enopion analysis, Ezek 38:22 fire-and-brimstone chain completed
- etc6-12: Beast-as-representative counter-argument engaged
- etc6-13: Rev 21:4 ECT tension made explicit
- etc6-14: Isa 2:10 as source text for 2 Thess 1:9 apo prosopou
- etc6-15: Degrees-of-punishment ECT argument addressed
- etc6-17: Anselmian argument assessed; 1 Tim 2:4, Ezek 33:11, Lam 3:33 added
- etc6-20: NEW — Jesus' judgment parables and imagery (full study)

---

*Study completed: 2026-02-20; updated 2026-03-01*
*Files: PROMPT.md, 01-topics.md, 02-verses.md, 03-analysis.md, CONCLUSION.md*
*Evidence items tracked in etc6-evidence.db and etc6-master-evidence.md*
*Data source: etc6-evidence.db (632 items, 19 studies)*
