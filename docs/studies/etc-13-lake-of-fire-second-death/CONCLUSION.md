...
| E9 | Rev 20:14 uses thanatos (death) twice: "death (thanatos) and hell (hades) were cast into the lake of fire. This is the second death (thanatos)" — the text uses death vocabulary, not torment vocabulary, to identify the lake | Rev 20:14 | Neutral | E394 *NEW* |
...
- AGAINST: E1/E204 (text identifies lake as "second death" — thanatos). E2/E124 (Rev 21:8: "second death"). E5/E377 (no torment formula for humans). E9/E394 (thanatos used twice in Rev 20:14). N1/N056 (text chose death vocabulary, not torment vocabulary). E21/E400 (wages of sin is death — didactic). E18/E378 (humans slain vs. symbolic entities cast alive). E19/E254 (humans devoured). N2/N057 (death itself destroyed — no more death).

**Step 2 — Clarity Assessment:**

| Item | Level | Rationale |
|------|-------|-----------|
| E17/E125 (Rev 20:10 torment formula) | Ambiguous | Apocalyptic genre. Subjects are non-human/symbolic (etc6-12: Gate 1/Gate 3 FAIL). The formula is stated for the devil, beast, false prophet — not for humans. |
...
AGAINST: 9+ Plain items (text identifies lake as "second death" — thanatos vocabulary; no torment formula for humans; death vocabulary used twice; wages of sin is death; humans slain/devoured; death itself destroyed; no more death).
...
- I2 (I-B): Requires "second death" to mean "torment" when the text defines it with thanatos -> conflicts with E/N -> I-B. Checked.
...
- Rom 6:23 "wages of sin is death" applied to "second death" interpretation: shared vocabulary (thanatos); didactic genre interprets apocalyptic. #4a verified.
- 1 Cor 15:26 "last enemy destroyed is death" applied to Rev 20:14 "death cast into lake": shared vocabulary (thanatos/katargeo); didactic interprets apocalyptic. #4a verified.
...
|--------|-----------|-----------|----------|----------------|
| E390 | Rev 2:11: "He that overcometh shall not be hurt of the second death" — adikeo (G91) = to wrong, injure, harm | Rev 2:11 | Neutral | etc6-13 |
| E391 | "Second death" (deuteros thanatos) occurs four times in Scripture — all in Revelation (2:11; 20:6; 20:14; 21:8) | Distribution data | Neutral | etc6-13 |
| E392 | "Lake of fire" (limne tou puros) occurs five times in Scripture — all in Revelation (19:20; 20:10; 20:14; 20:15; 21:8) | Distribution data | Neutral | etc6-13 |
| E393 | G3041 (limne): 10 NT occurrences — 5 literal (Luke, Lake of Gennesaret), 5 "lake of fire" (Revelation) | G3041 data | Neutral | etc6-13 |
| E394 | Rev 20:14 uses thanatos (death) twice: "death and hell cast into lake of fire. This is the second death" — death vocabulary, not torment vocabulary, identifies the lake | Rev 20:14 | Neutral | etc6-13 |
| E395 | Death and hades are personified throughout Revelation: Death rides pale horse (6:8), Christ holds keys (1:18), death/hades deliver up dead (20:13), death/hades cast into lake (20:14) | Rev 6:8; 1:18; 20:13-14 | Neutral | etc6-13 |
| E396 | Rev 21:4: "there shall be no more death" — appears immediately after the lake of fire passages | Rev 21:4 | Neutral | etc6-13 |
| E397 | 1 Cor 15:54: "Death is swallowed up in victory" — quoting Isa 25:8, in resurrection/abolition-of-death context | 1 Cor 15:54 | Neutral | etc6-13 |
| E398 | Hos 13:14: "O death, I will be thy plagues; O grave, I will be thy destruction" — destruction vocabulary directed at death itself | Hos 13:14 | Neutral | etc6-13 |
| E399 | 2 Tim 1:10: Christ "hath abolished death" — katargeo (G2673), same verb as 1 Cor 15:26 | 2 Tim 1:10 | Neutral | etc6-13 |
| E400 | Rom 6:23: "the wages of sin is death" — thanatos as the penalty for sin; same word as "second death" | Rom 6:23 | Cond. | etc6-13 |
| E401 | Nave's DEATH - SECOND lists death/destruction vocabulary passages (Ezek 18:4; Matt 10:28; Rom 6:23; 2 Thess 1:9; 2 Pet 2:12) alongside the four "second death" references | Nave's data | Neutral | etc6-13 |
| E402 | Rev 2:10-11 pairs "faithful unto death" (first death) with "not be hurt of the second death" — two deaths distinguished | Rev 2:10-11 | Neutral | etc6-13 |
| E403 | Deuteros (G1208, "second") in "second death" implies a first death exists; the ordinal distinguishes the two | G1208 usage | Neutral | etc6-13 |

New N-items:
| New ID | Implication | Based On | Position | First Appeared |
|--------|-------------|----------|----------|----------------|
| N056 | The text's own name for what the lake of fire does is "death" (second death), not "torment" — author chose thanatos, not basanizo | E204, E124, E394 | Neutral | etc6-13 |
| N057 | The casting of death/hades into the lake results in cessation of death: Rev 21:4 "no more death"; parallels 1 Cor 15:26 and Isa 25:8 | E395, E396, E065, E072 | Neutral | etc6-13 |
| N058 | "Second death" is distinguished from first death (physical) by ordinal adjective; first resurrection participants exempt from second death | E403, E389, E402 | Neutral | etc6-13 |

New I-items:
| New ID | Claim | Type | Position | First Appeared |
|--------|-------|------|----------|----------------|
| I059 | The "second death" involves eternal conscious torment (death = separation/torment, not cessation) | I-B | ECT-direction | etc6-13 |
| I060 | The "second death" means permanent cessation — the wicked die a second time and cease to exist | I-A | Cond. | etc6-13 |
| I061 | The lake of fire achieves permanent destruction of all that opposes God, resulting in Rev 21:4 "no more death" | I-A | Cond. | etc6-13 |
| I062 | The second death is a state of eternal separation from God rather than cessation | I-C | ECT-direction | etc6-13 |

Existing items with "Also In" updated to include etc6-13:
...
### Positional Tally (Cumulative: etc6-01b through etc6-13)
