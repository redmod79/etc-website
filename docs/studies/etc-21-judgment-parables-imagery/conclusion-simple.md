...
The decisive word is *[katakaio](https://www.blueletterbible.org/lexicon/g2618/kjv/tr/0-1/){:target="_blank"}* (G2618), meaning "burn down to the ground, consume completely." The *kata-* prefix intensifies the base verb ("burn") to denote thorough, complete burning. Jesus uses this word in both v.30 and v.40:
...
The "so shall it be" demands correspondence between the image and the reality. Tares consumed by fire = the wicked consumed at judgment. All 12 of *[katakaio](https://www.blueletterbible.org/lexicon/g2618/kjv/tr/0-1/){:target="_blank"}*'s NT occurrences describe total consumption: chaff burned up (Matt 3:12), earth burned up (2 Pet 3:10), trees burned up (Rev 8:7), Babylon utterly burned (Rev 18:8). Not one describes ongoing burning without consumption.
