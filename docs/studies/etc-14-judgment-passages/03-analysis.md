# etc6-14: Judgment Passages — Analysis

## Methodology
Each of the 8 major judgment passages is analyzed individually for what the text says versus what each side infers. Focus is on the actual vocabulary used in each passage. For passages covered in depth by prior studies, key findings are cross-referenced.

---

## Passage 1: Revelation 20:11-15 — Great White Throne Judgment

### What the Text Says
- A "great white throne" appears; earth and heaven flee from the one sitting on it (v.11)
...
- The outcome for death/hades: "cast into the lake of fire" — death itself is destroyed *(Examined in depth in etc6-13-lake-of-fire-second-death.)*
...
- The torment formula (Rev 20:10) is in a separate verse applied to the devil, beast, and false prophet *(Examined in depth in etc6-12-devil-beast-false-prophet.)*
...
## Passage 2: Matthew 25:31-46 — Sheep and Goats

### What the Text Says
- The Son of man comes in glory, sits on throne, separates nations as sheep from goats (vv.31-33)
- Sheep (right hand): "Come, ye blessed of my Father, inherit the kingdom prepared for you" (v.34)
- Goats (left hand): "Depart from me, ye cursed, into everlasting fire, prepared for the devil and his angels" (v.41)
- The everlasting fire was "prepared for the devil and his angels" — its primary designation is for non-human entities
...
- The same adjective aionios modifies both kolasis (punishment) and zoe (life) *(aionios examined in depth in etc6-08-greek-aionios-aion.)*
...
## Passage 3: Daniel 12:2 — Everlasting Life and Everlasting Contempt
...
### Vocabulary Analysis
- "sleep in the dust" — death as unconscious state in the earth (consistent with etc6-03, etc6-04 death-state studies)
- "everlasting life" (chayyey olam) — H2416 chay + H5769 olam *(olam examined in etc6-07-hebrew-olam-ad.)*
...
### What Each Side Infers
- **ECT inference:** "Everlasting contempt" implies ongoing conscious experience of shame/disgrace. This requires adding the concept of consciousness to a word that describes how others view the subjects, not what the subjects experience.
- **Conditionalist inference:** "Everlasting contempt" means the subjects are objects of permanent aversion/repulsion. The only other use (Isa 66:24) applies the word to dead bodies (peger), suggesting the contempt is the lasting reputation of the destroyed, not their ongoing experience. This requires the SIS connection between Dan 12:2 and Isa 66:24 (verified: shared rare vocabulary H1860).

---

## Passage 4: Isaiah 66:22-24 — Carcasses, Worm, and Fire

### What the Text Says
- Context: new heavens and new earth (v.22)
- All flesh comes to worship the LORD (v.23)
- "They shall go forth, and look upon the carcases of the men that have transgressed against me" (v.24)
- "For their worm shall not die, neither shall their fire be quenched" (v.24)
- "They shall be an abhorring unto all flesh" (v.24)

### Vocabulary Analysis
- "carcases" (peger, H6297) — This word means dead body/corpse. It appears 24 times in the OT and always refers to dead bodies, never living beings (Gen 15:11; Num 14:29,32; 1 Sam 17:46; Isa 14:19; 34:3; Nah 3:3).
- "worm shall not die" — Worms consume dead flesh. The imagery is of decomposition that is not interrupted (unquenchable decomposition of corpses).
- "fire...not quenched" — "Not quenched" (lo tikbeh) means not extinguished/not stopped before its work is complete (cf. Jer 17:27 — fire that "shall not be quenched" burned Jerusalem; the city is not still burning).
- "abhorring" (dera'on, H1860) — Same word as Dan 12:2 "contempt." Object of aversion.
- The subjects are "men that have transgressed" — but the text states the worshippers look upon their "carcases" (dead bodies). The transgressors are dead.
- "slain of the LORD shall be many" (v.16) — slain, not tormented
- "shall be consumed together" (v.17) — consumption vocabulary

### What Each Side Infers
- **ECT inference:** The "worm that dies not" and "fire not quenched" imagery represents eternal conscious torment. This requires: (a) ignoring peger (the subjects are dead bodies, not living beings); (b) treating decomposition imagery as torment imagery; (c) reading "not quenched" as "burning forever" rather than "not extinguished before completing its work."
- **Conditionalist inference:** The text describes the aftermath of divine judgment — dead bodies (peger) being consumed by worm and fire, observed by the living with abhorrence. The imagery is of completed destruction viewed as a permanent memorial/warning. The subjects are explicitly corpses.

### Critical Observation
The Hebrew peger is determinative for this passage. Worms and fire act upon corpses, not conscious beings. Jesus quotes this imagery in Mark 9:48, but Isa 66:24 itself describes dead bodies.

---

## Passage 5: John 5:28-29 — Resurrection of Life / Resurrection of Damnation
...
## Passage 6: 2 Thessalonians 1:7-10 — Everlasting Destruction

### What the Text Says
- "The Lord Jesus shall be revealed from heaven with his mighty angels" (v.7)
- "In flaming fire taking vengeance on them that know not God, and that obey not the gospel" (v.8)
- "Who shall be punished with everlasting destruction from the presence of the Lord, and from the glory of his power" (v.9)
- "When he shall come to be glorified in his saints" (v.10)

### Vocabulary Analysis
- "everlasting destruction" (olethron aionion) — G3639 olethros = destruction/ruin (from ollymi, to destroy). The word appears 4 times in the NT (1 Cor 5:5; 1 Thess 5:3; 2 Thess 1:9; 1 Tim 6:9). In every occurrence it means destruction/ruin. *(Examined in etc6-06-destruction-words.)*
...
## Passage 7: Hebrews 10:26-31 — Fearful Expectation of Judgment

### What the Text Says
- "If we sin wilfully after that we have received the knowledge of the truth, there remaineth no more sacrifice for sins" (v.26)
- "But a certain fearful looking for of judgment and fiery indignation, which shall devour the adversaries" (v.27)
- "He that despised Moses' law died without mercy" (v.28)
- "Of how much sorer punishment [timoria], suppose ye, shall he be thought worthy" (v.29)
- "Vengeance belongeth unto me, I will recompense" (v.30, quoting Deut 32:35)
- "The Lord shall judge his people" (v.30, quoting Deut 32:36)
...
### Vocabulary Analysis
- "fiery indignation, which shall devour" (v.27) — "devour" (esthio, G2068) is consumption/destruction vocabulary. Fire that devours consumes what it burns.
...
## Passage 8: Romans 2:5-11 — Wrath, Indignation, Tribulation, Anguish

### What the Text Says
- "Treasurest up unto thyself wrath against the day of wrath and revelation of the righteous judgment of God" (v.5)
- "Who will render to every man according to his deeds" (v.6)
- "To them who by patient continuance in well doing seek for glory and honour and immortality, eternal life" (v.7)
- "But unto them that are contentious, and do not obey the truth, but obey unrighteousness, indignation and wrath" (v.8)
- "Tribulation and anguish, upon every soul of man that doeth evil" (v.9)
- "But glory, honour, and peace, to every man that worketh good" (v.10)
- "For as many as have sinned without law shall also perish without law" (v.12)

### Vocabulary Analysis
- "seek for...immortality" (aphtharsia, G861) — Immortality is something humans must seek, not something they inherently possess. The righteous are given immortality as a gift with eternal life. *(Examined in etc6-02-who-has-immortality.)*
...
## Summary of Vocabulary Across All 8 Passages
