...
**1 Enoch** (roughly 3rd century BC) describes four separate compartments where conscious souls wait after death -- righteous separated from wicked. This departs significantly from the Old Testament's picture of [sheol](https://www.blueletterbible.org/lexicon/h7585/kjv/wlc/0-1/){:target="_blank"} as a silent, undifferentiated state.
